(function() {
    ...
    var colors = ['72,35,68', '255, 248, 220', '66,152,103', '210, 105, 30', '224,33,48'];
    ...
    function tweenTriangle(tri) {
        ...
        var x = (800+Math.random()*100)*Math.cos(t) + width*0.5;
        var y = (400+Math.random()*100)*Math.sin(t) + height*0.5-20;
